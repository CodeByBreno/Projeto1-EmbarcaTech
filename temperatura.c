...
void converter_temperatura() {
    ...
    switch (unidade_origem) {
        case 1: // Celsius
            if (unidade_destino == 2) { // Celsius -> Fahrenheit
                resultado = (temperatura * 9 / 5) + 32;
            } else if (unidade_destino == 3) { // Celsius -> Kelvin
                resultado = temperatura + 273.15;
            }
            break;
        case 2: // Fahrenheit
            if (unidade_destino == 1) { // Fahrenheit -> Celsius
                resultado = (temperatura - 32) * 5 / 9;
            } else if (unidade_destino == 3) { // Fahrenheit -> Kelvin
                resultado = ((temperatura - 32) * 5 / 9) + 273.15;
            }
            break;
        case 3: // Kelvin
            if (unidade_destino == 1) { // Kelvin -> Celsius
                resultado = temperatura - 273.15;
            } else if (unidade_destino == 2) { // Kelvin -> Fahrenheit
